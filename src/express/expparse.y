...
procedure_id     : TOK_IDENTIFIER
                 ...
                 | TOK_BUILTIN_PROCEDURE
                  { $$ = $1; }
                 ;
/* rules from ISO 10303-11:2004 bnf (courtesy craigl64)
 *
 ...
 * Part 11 ed1 rule 263, ed2 rule 276
 * used in unary_expression and assignable */
qualifier        : TOK_DOT TOK_IDENTIFIER
                  { /* attribute_qualifier = ’.’ attribute_ref .
                     * Part 11 ed1 rule 169, ed2 rule 179 */
                    $$.expr = $$.first =
                 ...
                 | TOK_BACKSLASH TOK_IDENTIFIER
                  { /* group_qualifier = ’\’ entity_ref .
                     * Part 11 ed1 rule 219, ed2 rule 232 */
                    $$.expr = $$.first =
                    BIN_EXPcreate(OP_GROUP,(Expression )0,(Expression )0);
                    $$.expr->e.op2 = EXPcreate(Type_Identifier);
                    $$.expr->e.op2->symbol = *$2;
                ...
                | TOK_LEFT_BRACKET simple_expression TOK_RIGHT_BRACKET
                  { /* index_qualifier = ’[’ index_1 [ ’:’ index_2 ] ’]’ .
                     * Part 11 ed1 rule 226, ed2 rule 239 */
                    $$.expr = $$.first =
 ...
 * Part 11 ed1 rule 264, ed2 rule 277 */
...
general_ref        : assignable
                    { $$ = $1; }
                   ;
/* group_ref is never used due to reduce/reduce conflict
**                 | assignable group_ref
**                  { $2->e.op1 = $1;
**                    $$ = $2;}
*/
