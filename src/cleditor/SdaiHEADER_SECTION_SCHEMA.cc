...
#ifdef __O3DB__
void 
SdaiSection_language::oodb_reInit ()
{	eDesc = header_section_schemae_section_language;
	attributes [0].aDesc = a_0section;
	attributes [1].aDesc = a_1default_language;
}
#endif
...
#ifdef __O3DB__
void 
SdaiFile_population::oodb_reInit ()
{	eDesc = header_section_schemae_file_population;
	attributes [0].aDesc = a_2governing_schema;
	attributes [1].aDesc = a_3determination_method;
	attributes [2].aDesc = a_4governed_sections;
}
#endif
...
#ifdef __O3DB__
void 
SdaiFile_name::oodb_reInit ()
{	eDesc = header_section_schemae_file_name;
	attributes [0].aDesc = a_5name;
	attributes [1].aDesc = a_6time_stamp;
	attributes [2].aDesc = a_7author;
	attributes [3].aDesc = a_8organization;
	attributes [4].aDesc = a_9preprocessor_version;
	attributes [5].aDesc = a_10originating_system;
	attributes [6].aDesc = a_11authorization;
}
#endif
...
#ifdef __O3DB__
void 
SdaiSection_context::oodb_reInit ()
{	eDesc = header_section_schemae_section_context;
	attributes [0].aDesc = a_12section;
	attributes [1].aDesc = a_13context_identifiers;
}
#endif
...
#ifdef __O3DB__
void 
SdaiFile_description::oodb_reInit ()
{	eDesc = header_section_schemae_file_description;
	attributes [0].aDesc = a_14description;
	attributes [1].aDesc = a_15implementation_level;
}
#endif
...
#ifdef __O3DB__
void 
SdaiFile_schema::oodb_reInit ()
{	eDesc = header_section_schemae_file_schema;
	attributes [0].aDesc = a_16schema_identifiers;
}
#endif
