...
bool compareOneSchName( std::string lib, std::string file ) {
    ...
    cout << "This pair of schema names do not match - " << lib << " and " << file << endl;
    return false;
}
 ...
 */
void checkSchemaName( Registry & reg, STEPfile & sf ) {
    bool match = false;
    std::string sname;
    STEPattribute *attr;
    const Schema * sc;
    ...
    if (!match) {
        cerr << "ERROR - schema name mismatch. Tried all available combinations." << endl;
        exit(1);
    }
}
...
///////////////////////////////////////////////////////////////////////////////
    ...
    checkSchemaName( registry, sfile );
