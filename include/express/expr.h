...
#define EXP_destroy(x)  ALLOC_destroy(&EXP_fl,(Freelist *)(Generic)x)
#define OP_new()    (struct Op_Subexpression *)ALLOC_new(&OP_fl)
#define OP_destroy(x)   ALLOC_destroy(&OP_fl,(Freelist *)(Generic)x)
#define QUERY_new() (struct Query_ *)ALLOC_new(&QUERY_fl)
#define QUERY_destroy(x) ALLOC_destroy(&QUERY_fl,(Freelist *)(Generic)x)
#define QUAL_ATTR_new() (struct Qualified_Attr *)ALLOC_new(&QUAL_ATTR_fl)
#define QUAL_ATTR_destroy(x) ALLOC_destroy(&QUAL_ATTR_fl,(Freelist *)(Generic)x)
