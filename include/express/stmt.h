...
#define STMT_destroy(x) ALLOC_destroy(&STMT_fl,(Freelist *)(Generic)x)

#define ALIAS_new()     (struct Alias_ *)ALLOC_new(&ALIAS_fl)
#define ALIAS_destroy(x)        ALLOC_destroy(&ALIAS_fl,(Freelist *)(Generic)x)
#define ASSIGN_new()        (struct Assignment_ *)ALLOC_new(&ASSIGN_fl)
#define ASSIGN_destroy(x)       ALLOC_destroy(&ASSIGN_fl,(Freelist *)(Generic)x)
#define CASE_new()      (struct Case_Statement_ *)ALLOC_new(&CASE_fl)
#define CASE_destroy(x)     ALLOC_destroy(&CASE_fl,(Freelist *)(Generic)x)
#define COMP_STMT_new()     (struct Compound_Statement_ *)ALLOC_new(&COMP_STMT_fl)
#define COMP_STMT_destroy(x)        ALLOC_destroy(&COMP_STMT_fl,(Freelist *)(Generic)x)
#define COND_new()      (struct Conditional_ *)ALLOC_new(&COND_fl)
#define COND_destroy(x)     ALLOC_destroy(&COND_fl,(Freelist *)(Generic)x)
#define LOOP_new()      (struct Loop_ *)ALLOC_new(&LOOP_fl)
#define LOOP_destroy(x)     ALLOC_destroy(&LOOP_fl,(Freelist *)(Generic)x)
#define PCALL_new()     (struct Procedure_Call_ *)ALLOC_new(&PCALL_fl)
#define PCALL_destroy(x)    ALLOC_destroy(&PCALL_fl,(Freelist *)(Generic)x)
#define RET_new()       (struct Return_Statement_ *)ALLOC_new(&RET_fl)
#define RET_destroy(x)      ALLOC_destroy(&RET_fl,(Freelist *)(Generic)x)
