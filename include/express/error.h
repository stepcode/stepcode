...
extern SC_EXPRESS_EXPORT void ERRORreport PROTO( ( enum ErrorCode, ... ) );

struct Symbol_; /* mention Symbol to avoid warning on following line */
extern SC_EXPRESS_EXPORT void ERRORreport_with_symbol PROTO( ( enum ErrorCode, struct Symbol_ *, ... ) );
extern SC_EXPRESS_EXPORT void ERRORreport_with_line PROTO( ( enum ErrorCode, int, ... ) );
...
extern SC_EXPRESS_EXPORT void ERRORset_warning PROTO( ( char *, bool ) );
extern SC_EXPRESS_EXPORT void ERRORset_all_warnings PROTO( ( bool ) );
