...
extern SC_EXPRESS_EXPORT Entity       ENTITYfind_inherited_entity( struct Scope_ *, const char *, int );
extern SC_EXPRESS_EXPORT Symbol *ENTITYfind_inherited_attribute( struct Scope_ *, const char *, struct Symbol_ ** );
...
extern SC_EXPRESS_EXPORT Variable     ENTITYget_named_attribute( Entity, const char * );
